...
fn caste_name(caste: Caste) -> &'static str {
    match caste {
        Caste::Dawn => "Dawn",
        Caste::Zenith => "Zenith",
...
fn group_name(group: AttributeGroup) -> &'static str {
    match group {
...
fn attr_name(kind: AttributeKind) -> &'static str {
    match kind {
...
fn ability_name(kind: AbilityKind) -> &'static str {
    match kind {
...
fn virtue_name(kind: VirtueKind) -> &'static str {
    match kind {
...
fn source_tag(source: DotSource) -> &'static str {
    match source {
        DotSource::Base => "base",
...
fn intimacy_kind(k: IntimacyKind) -> &'static str {
    match k {
