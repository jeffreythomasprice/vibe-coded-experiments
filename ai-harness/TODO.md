...
We should expand the demo page to also include embeddings models for each provider.
...
sensible error messages for things like "embeddings string input is too big" and "you need to pay more to the provider"
