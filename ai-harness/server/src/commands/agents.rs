...
#[tauri::command]
pub async fn list_agents(service: tauri::State<'_, Arc<Service>>) -> Result<Vec<AgentConfig>, ErrorReport> {
...
#[tauri::command]
pub fn tool_catalog(service: tauri::State<'_, Arc<Service>>) -> Vec<ToolSpec> {
...
#[tauri::command]
pub async fn delete_agent(service: tauri::State<'_, Arc<Service>>, id: AgentConfigId) -> Result<(), ErrorReport> {
