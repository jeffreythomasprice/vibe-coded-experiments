...
fn draft_from_choice(mode: BattleMode, choice: Option<Choice>, name: &str, speed_override: &str, dv_override: &str) -> SavedAction {
    match choice {
        ...
        None => SavedAction {
            ...
            name: String::new(),
            note: String::new(),
            shape: SavedShape::Single { mode, kind: exalted_battle_wheel::battle::ActionKind::Custom, speed: 5, dv_penalty: 0 },
            effects: Vec::new(),
        },
    }
}
...
mod tests {
    use super::*;
    use exalted_battle_wheel::battle::{apply, template, SequenceKind, Side};
    ...
    fn choice_for_resolves_every_catalog_range() {
        ...
        let personal_len = exalted_battle_wheel::battle::PERSONAL_CATALOG.len();
    ...
    fn choice_for_finds_a_saved_action_by_id() {
        ...
        let id = library
            .add(
                ...
                String::new(),
                SavedShape::Single { mode: BattleMode::Personal, kind: exalted_battle_wheel::battle::ActionKind::Attack, speed: 4, dv_penalty: -1 },
                Vec::new(),
            )
            .unwrap();
    ...
    fn choice_for_hides_a_saved_action_from_a_different_mode() {
        ...
        let id = library
            .add(
                ...
                String::new(),
                SavedShape::Single { mode: BattleMode::Mass, kind: exalted_battle_wheel::battle::ActionKind::Rally, speed: 4, dv_penalty: -1 },
                Vec::new(),
            )
            .unwrap();
