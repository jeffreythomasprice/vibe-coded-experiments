    ...
    pub fn entry(self) -> Entry {
        match self {
            ...
            Topic::Config => Entry {
                ...
                interacts: "This is a separate server the app talks to over plain HTTP, unrelated to a peer-to-peer multiplayer room \u{2014} an admin here is a server administrator, not a room admin.",
                source: Source::AppConvention,
            },
            ...
            Topic::ConfigAdminFlag => Entry {
                ...
                interacts: "Takes effect on that code's very next request. This is server administration, unrelated to a multiplayer room's admin role, which only governs who may change one specific battle.",
                source: Source::AppConvention,
            },
